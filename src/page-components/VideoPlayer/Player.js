                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button onClick={this.handleSetPlaybackRate} value={0.1}>0.1x</button>
                                    <button onClick={this.handleSetPlaybackRate} value={0.25}>0.25x</button>
