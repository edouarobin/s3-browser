...
export default function Home() {
  ...
  const { data: keyOrPrefixList, error } = useSWRImmutable(
  ...
  return (
    <BaseLayout>
      <div style={{ padding: '0px 10px', minHeight: 'calc(100vh - 64px)' }}>
        <div style={{ fontSize: '18px', fontWeight: 'bold', padding: '0 0 0px 0' }}>
